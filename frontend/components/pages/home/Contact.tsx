...
export default async function Contact() {
  ...
  return (
    <section
      ...
      className="scroll-mt-24 bg-white py-24 lg:py-40"
    >
      <div className="mx-auto max-w-(--max-content-width) px-4 sm:px-6 lg:px-12">
        <div className="grid items-start gap-14 lg:grid-cols-2 lg:gap-24">
          <div className="reveal-left min-w-0 text-center lg:text-left">
            ...
            <h2
              id="contact-heading"
              className="mt-3 mb-7 font-['Cormorant_Garamond'] text-[clamp(34px,11vw,56px)] leading-tight font-light text-stone-darkest"
            >
            ...
            <dl className="mx-auto w-fit space-y-6 text-left lg:mx-0">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      <dt className="text-[10px] font-medium uppercase tracking-[0.18em] text-stone-light">
                        {item.label}
                      </dt>

                      <dd className="mt-0.5 wrap-break-word text-sm text-stone-darkest">
                        {item.href ? (
                          <a
                            href={item.href}
                            className="transition-colors hover:text-gold focus-visible:text-gold focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-gold"
                          >
                            {item.value}
                          </a>
                        ) : (
