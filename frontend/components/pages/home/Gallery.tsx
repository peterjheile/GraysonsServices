...
export default function Gallery({
  ...
  const homepageImages = [...images].sort(
...
function ProjectImageCard({
  ...
  const imageSizes =
    image.homepage_size === "wide"
      ? "(min-width: 1440px) 880px, (min-width: 1024px) 66vw, (min-width: 640px) 100vw, 100vw"
      : "(min-width: 1440px) 440px, (min-width: 1024px) 33vw, (min-width: 640px) 50vw, 100vw";
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-linear-to-t from-stone-darkest/95 via-stone-darkest/15 to-transparent" />

      {/* Subtle hover tint */}
      <div className="absolute inset-0 bg-stone-darkest/0 transition-colors duration-500 group-hover:bg-stone-darkest/15" />
      ...
      <div className="absolute inset-x-0 bottom-0 p-6 lg:p-8">
        ...
        <h3 className="font-['Cormorant_Garamond'] text-2xl font-medium leading-tight text-white lg:text-3xl">
          {project.title}
        </h3>
