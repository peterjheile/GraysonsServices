...
export default function ServicesHero() {
  ...
  return (
    <section className="relative h-[72vh] min-h-[560px] max-h-[820px] overflow-hidden flex items-end bg-[#1a1714]">
      ...
      <div className="absolute left-12 top-0 bottom-0 w-px bg-gradient-to-b from-transparent via-[#b8975a]/30 to-transparent hidden lg:block" />
      ...
      <div className="relative z-10 w-full max-w-[1440px] mx-auto px-6 lg:px-12 pb-20 lg:pb-28">
        ...
        <div className="flex items-center gap-3 mb-8" style={{ animation: 'hero-word-in 0.8s 0.1s both' }}>
          ...
          <span className="text-[10px] tracking-[0.3em] uppercase text-[#b8975a]">Services</span>
        </div>
